...
export const getDefaultGames = (): GameItem[] => [
  {
    id: 'game_1',
    title: 'Tebak Pasangan Sayuran',
    category: 'Edukasi',
    type: 'modular_game1',
    description: 'Tebak Pasangan Sayuran',
    instructions: 'Buka dan temukan 2 kartu bergambar sayuran yang cocok.',
    passScore: 4,
  ...
  {
    id: 'game_2',
    title: 'Tebak Pasangan Tanaman Pangan',
    category: 'Edukasi',
    type: 'modular_game2',
    description: 'Tebak Pasangan Tanaman Pangan',
    instructions: 'Temukan pasangan kartu tanaman pangan hingga semua kartu terbuka.',
    passScore: 4,
    thumbnailIcon: 'Gamepad2',
    isBuiltIn: true,
    createdAt: new Date().toISOString(),
  ...
  {
    id: 'game_3',
    title: 'Tebak Pasangan Bumbu & Rimpang',
    category: 'Edukasi',
    type: 'modular_game3',
    description: 'Tebak Pasangan Bumbu & Rimpang',
    instructions: 'Buka dan pasangkan kartu rimpang & bumbu secara tepat.',
    passScore: 4,
    thumbnailIcon: 'Gamepad2',
    isBuiltIn: true,
    createdAt: new Date().toISOString(),
  ...
  {
    id: 'game_word_guess',
    title: 'Tebak Kata Pintar',
    category: 'Edukasi',
    type: 'custom_html',
    description: 'Tebak Kata Pintar',
    code: GAME_TEMPLATES[0].code,
    instructions: 'Pilih huruf pada keyboard virtual untuk menebak kata misteri.',
    passScore: 70,
    thumbnailIcon: 'Code2',
    isBuiltIn: false,
    createdAt: new Date().toISOString()
  ...
  {
    id: 'game_speed_quiz',
    title: 'Kuis Cepat Berwaktu',
    category: 'Edukasi',
    type: 'custom_html',
    description: 'Kuis Cepat Berwaktu',
    code: GAME_TEMPLATES[1].code,
    instructions: 'Pilih opsi jawaban yang benar sebelum waktu habis!',
    passScore: 60,
    thumbnailIcon: 'Code2',
    isBuiltIn: false,
    createdAt: new Date().toISOString()
  },
  {
    ...
    instructions: 'Gunakan tombol keyboard atau layar untuk menangkap 10 bintang!',
    passScore: 100,
    thumbnailIcon: 'Gamepad2',
    isBuiltIn: false,
    createdAt: new Date().toISOString()
  },
  {
    ...
    category: 'Edukasi',
    type: 'custom_tsx',
    description: 'Flashcard Interaktif',
    code: GAME_TEMPLATES[3].code,
    instructions: 'Klik kartu untuk membalik dan melihat kunci jawaban.',
    passScore: 100,
    thumbnailIcon: 'Code2',
    isBuiltIn: false,
    createdAt: new Date().toISOString()
